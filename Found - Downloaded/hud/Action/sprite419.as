...
// [Initial MovieClip Action of sprite 419]
#initclip 7
class com.rockstargames.gtav.hud.NEW_HUD extends com.rockstargames.ui.core.BaseContainer
{
    var loadedHudComps, listArray, listManager, charColourEnum, COMPONENT_ARRAY, MAX_HUD_COMPONENTS, loadedCompPrefix, IS_HUD_VISIBLE, mcPrefix, TIMELINE, isWideScreen, NEEDS_BIGGER_HELP_AND_SUBTITLES;
    function NEW_HUD()
    {
        super();
        loadedHudComps = {};
    ...
    function createComponentMovieClip(currentComp)
    {
        ...
        var _loc8 = "MP_RANK_BAR";
        if (!isWideScreen)
        {
            _loc8 = "MP_RANK_BAR_smaller";
        } // end if
        ...
        switch (_loc5)
        {
            ...
            case 140:
            {
                currentComp._mc = TIMELINE.attachMovie(_loc8, _loc3, _loc4);
                break;
            } 
        } // End of switch
