...
// [Initial MovieClip Action of sprite 421]
#initclip 9
class com.rockstargames.gtav.hud.hudComponents.HUD_RADIO_STATIONS_WHEEL extends com.rockstargames.ui.hud.HUD_COMPONENT
{
    var TIMELINE, CONTENT, BOUNDING_BOX, m_bQuickSelectMode, stationDisplayMC, stationNameTF, artistMC, trackMC, shareTF, sharedTF, stationNameTFOutline, artistMCOutline, trackMCOutline, shareTFOutline, sharedTFOutline, blipLayer, blipLayerOutline, stationList, stationRingMC, playingOutlineMC, _HUD, _enumID;
    ...
    function INITIALISE(mc)
    {
        ...
        stationNameTFOutline = stationDisplayMC.stationTFOutline;
        artistMCOutline = stationDisplayMC.artistMCOutline;
        trackMCOutline = stationDisplayMC.trackMCOutline;
        shareTFOutline = stationDisplayMC.shareTFOutline;
        shareTFOutline.autoSize = "left";
        sharedTFOutline = stationDisplayMC.sharedTFOutline;
        if (blipLayer)
        {
        ...
        if (blipLayerOutline)
        {
            blipLayerOutline.removeMovieClip();
        } // end if
        blipLayerOutline = stationDisplayMC.createEmptyMovieClip("blipLayerOutline", 1001);
        ...
        _loc2.setTextWithIcons("RADIO_SHARE", blipLayerOutline, shareTFOutline, 0, 14, 2, false);
        com.rockstargames.ui.utils.Localisation.setTextWithTranslation(sharedTFOutline, "RADIO_SHARED", com.rockstargames.ui.game.GameInterface.GENERIC_TYPE, true);
        shareTF._x = shareTFOutline._x = (shareTF._width + blipLayer._width * 0.500000) * -0.500000;
        blipLayer._x = blipLayerOutline._x = shareTF._x + shareTF._width + 140;
        blipLayer._y = blipLayerOutline._y = blipLayer._y + 8;
        shareTF._visible = shareTFOutline._visible = blipLayer._visible = blipLayerOutline._visible = false;
        sharedTF._visible = sharedTFOutline._visible = false;
    ...
    function SET_RADIO_STATIONS(params)
    {
        ...
        artistMCOutline.setDelayTimeout(_loc2);
        trackMCOutline.setDelayTimeout(_loc2);
    } // End of the function
    function QUICK_SELECT_RADIO_STATION(params)
    {
        ...
        if (_loc3 != undefined && _loc3 >= 0)
        {
            ...
            stationNameTFOutline.text = stationNameTF.text;
    ...
    function SET_CURRENTLY_PLAYING(params)
    {
        ...
        sharedTF._visible = sharedTFOutline._visible = false;
        shareTF._visible = shareTFOutline._visible = blipLayer._visible = blipLayerOutline._visible = _loc4;
        if (_loc3 != undefined)
        {
            artistMC.txtString.text = artistMCOutline.txtString.text = _loc3;
            artistMC._visible = artistMCOutline._visible = true;
        } // end if
        if (_loc2 != undefined)
        {
            trackMC.txtString.text = trackMCOutline.txtString.text = _loc2;
            trackMC._visible = trackMCOutline._visible = true;
        } // end if
    } // End of the function
    function SET_AS_SHARED()
    {
        sharedTF._visible = sharedTFOutline._visible = true;
        shareTF._visible = shareTFOutline._visible = blipLayer._visible = blipLayerOutline._visible = false;
    ...
    {
        artistMC._visible = artistMCOutline._visible = false;
        trackMC._visible = trackMCOutline._visible = false;
    } // End of the function
    function SHOW()
    {
