...
#initclip 7
class com.rockstargames.gtav.pauseMenu.pauseMenuItems.singleplayer.PauseMenuLifestyleStatsView extends com.rockstargames.gtav.pauseMenu.pauseMenuItems.PauseMenuViewBase
{
    var viewLinkageList, viewContainer, itemY, itemList, rowSpacing, dataList, direction, topEdge, visibleItems, highlightedItem;
    function PauseMenuLifestyleStatsView()
    {
        super();
    } // End of the function
    function addDisplayItem(i, _dataArray)
    {
        ...
        _loc2._y = itemY;
        var _loc3 = (com.rockstargames.gtav.pauseMenu.pauseMenuItems.singleplayer.PauseMenuLifestyleStatsItem)(_loc2);
