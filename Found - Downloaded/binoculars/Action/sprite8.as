...
class com.rockstargames.ui.core.BaseScreenLayout extends com.rockstargames.gtav.levelDesign.BaseScriptUI
{
    ...
    function getDisplayConfig(shouldSet)
    {
        ...
        if (shouldSet)
        {
            this.SET_DISPLAY_CONFIG(_loc2.screenWidth, _loc2.screenHeight, _loc2.safeTop, _loc2.safeBottom, _loc2.safeLeft, _loc2.safeRight, _loc2.isWideScreen, _loc2.isHiDef);
        } // end if
        return (_loc2);
    } // End of the function
    ...
    function positionToScreenLayout(mc, position, onPixel)
    {
        ...
        switch (position)
        {
            ...
            case "xCC":
            {
                _loc3 = safeLeft + (safeRight - safeLeft) / 2;
