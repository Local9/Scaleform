...
class com.rockstargames.gtav.pauseMenu.pauseMenuItems.singleplayer.PauseMenuFreemodeItem extends com.rockstargames.gtav.pauseMenu.pauseMenuItems.PauseMenuBaseItem
{
    ...
    function set data(_d)
    {
        ...
        com.rockstargames.ui.utils.UIText.setSizedText(itemTextLeft, this.__get__data()[0]);
        ...
        if (isOption)
        {
            ...
            else
            {
                ...
                com.rockstargames.ui.utils.UIText.setSizedText(itemTextRight, _loc4);
                itemTextRight.autoSize = true;
                if (itemTextRight._width > 128)
                {
                    itemTextRight.autoSize = false;
                    com.rockstargames.ui.utils.UIText.setSizedText(itemTextRight, _loc4, true);
