...
class com.rockstargames.gtav.pauseMenu.pauseMenuItems.singleplayer.PauseMenuCrewListModel extends com.rockstargames.ui.components.GUIModel
{
    ...
    function createView(_viewIndex, _params)
    {
        ...
        if (_loc2 == undefined)
        {
            _loc2 = new com.rockstargames.gtav.pauseMenu.pauseMenuItems.singleplayer.PauseMenuCrewListView();
        } // end if
    ...
    function nextItem()
    {
        var _loc3 = (com.rockstargames.gtav.pauseMenu.pauseMenuItems.singleplayer.PauseMenuCrewListView)(this.getCurrentView());
        var _loc7 = 0;
    ...
    function prevItem()
    {
        var _loc4 = (com.rockstargames.gtav.pauseMenu.pauseMenuItems.singleplayer.PauseMenuCrewListView)(this.getCurrentView());
        var _loc7 = 0;
    ...
    {
        var _loc3 = (com.rockstargames.gtav.pauseMenu.pauseMenuItems.singleplayer.PauseMenuCrewListView)(this.getCurrentView());
        var _loc4 = (com.rockstargames.gtav.pauseMenu.pauseMenuItems.singleplayer.PauseMenuCrewRanksView)(_loc3.__get__sidecarColumn());
        for (var _loc2 = 0; _loc2 < _loc3.itemList.length; ++_loc2)
        {
            _loc3.itemList[_loc2].highlighted = false;
            _loc4.itemList[_loc2].highlighted = false;
        } // end of for
    } // End of the function
