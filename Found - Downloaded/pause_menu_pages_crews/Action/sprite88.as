...
// [Initial MovieClip Action of sprite 88]
#initclip 26
class com.rockstargames.gtav.pauseMenu.pauseMenuItems.singleplayer.PauseMenuCrewRanksModel extends com.rockstargames.ui.components.GUIModel
{
    var viewList, viewIndex, getCurrentView, setItem;
    function PauseMenuCrewRanksModel()
    {
        super();
    } // End of the function
    function createView(_viewIndex, _params)
    {
        ...
        if (_loc2 == undefined)
        {
            _loc2 = new com.rockstargames.gtav.pauseMenu.pauseMenuItems.singleplayer.PauseMenuCrewRanksView();
        } // end if
    ...
    function removeDataFromSlot(_viewIndex, _slotIndex)
    {
        ...
        _loc2.destroy();
        viewIndex = 0;
        var _loc3 = (com.rockstargames.gtav.pauseMenu.pauseMenuItems.singleplayer.PauseMenuCrewRanksView)(this.getCurrentView());
    } // End of the function
    function nextItem()
    {
        var _loc3 = (com.rockstargames.gtav.pauseMenu.pauseMenuItems.singleplayer.PauseMenuCrewRanksView)(this.getCurrentView());
    ...
    function prevItem()
    {
        var _loc4 = (com.rockstargames.gtav.pauseMenu.pauseMenuItems.singleplayer.PauseMenuCrewRanksView)(this.getCurrentView());
        var _loc7 = 0;
