...
#initclip 5
class com.rockstargames.gtav.pauseMenu.pauseMenuItems.singleplayer.PauseMenuTextFullModel extends com.rockstargames.ui.components.GUIModel
{
    var viewList, viewIndex, getCurrentView, setItem;
    function PauseMenuTextFullModel()
    {
        super();
    } // End of the function
    function createView(_viewIndex, _params)
    {
        ...
        if (_loc2 == undefined)
        {
            _loc2 = new com.rockstargames.gtav.pauseMenu.pauseMenuItems.singleplayer.PauseMenuTextFullView();
        } // end if
    ...
    function removeDataFromSlot(_viewIndex, _slotIndex)
    {
        ...
        _loc2.destroy();
        viewIndex = 0;
        var _loc3 = (com.rockstargames.gtav.pauseMenu.pauseMenuItems.singleplayer.PauseMenuTextFullView)(this.getCurrentView());
    } // End of the function
    function nextItem()
    {
        var _loc3 = (com.rockstargames.gtav.pauseMenu.pauseMenuItems.singleplayer.PauseMenuTextFullView)(this.getCurrentView());
    ...
    function prevItem()
    {
        var _loc4 = (com.rockstargames.gtav.pauseMenu.pauseMenuItems.singleplayer.PauseMenuTextFullView)(this.getCurrentView());
        var _loc7 = 0;
