...
class com.rockstargames.gtav.pauseMenu.pauseComponents.MP_MATCHMAKING_VEHICLE_INFO extends com.rockstargames.gtav.pauseMenu.pauseComponents.PauseMenuComponentBase
{
    ...
    function SET_TITLE(nameStr, classStr)
    {
        ...
        if (_loc3 == "" && _loc4 == "" || _loc3 == undefined && _loc4 == undefined)
        {
            CONTENT.innerMC._x = -74;
        }
        else
        {
    ...
    {
        firstload = true;
        com.rockstargames.ui.tweenStar.TweenStarLite.removeTweenOf(manufLoader);
        manufLoader._alpha = 0;
        var _loc2 = 0.200000;
        com.rockstargames.ui.tweenStar.TweenStarLite.to(manufLoader, _loc2, {_alpha: 100});
    } // End of the function
    function ON_DESTROY()
    {
        com.rockstargames.ui.tweenStar.TweenStarLite.removeTweenOf(manufLoader);
