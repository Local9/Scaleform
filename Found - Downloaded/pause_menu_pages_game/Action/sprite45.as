...
class com.rockstargames.gtav.levelDesign.MissionCompleteItem extends com.rockstargames.ui.components.GUIMenuItem
{
    ...
    function set data(_d)
    {
        ...
        com.rockstargames.ui.utils.UIText.setSizedText(innerMC.itemTextLeft, _loc3[0], true, false);
        var _loc8 = _loc3.length > 1;
        com.rockstargames.ui.utils.UIText.setDescText(innerMC.descTF, _loc8 ? (_loc3[1]) : (""), true);
        bgMC._height = _loc8 ? (innerMC.descTF._y + innerMC.descTF.textHeight + 5) : (25);
        com.rockstargames.ui.utils.UIText.setSizedText(innerMC.itemTextRight, _loc2, false, false, 0, 13);
        if (id == 10)
        {
